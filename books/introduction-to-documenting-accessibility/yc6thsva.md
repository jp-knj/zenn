...
組織内でドキュメントを共有する際、その理解の基準が一致していないと、意見の食い違いや誤解が生じやすくなります。例えば、新しいアイディアを提案するチームメンバーが、他のメンバーからの疑問や批判に直面することはあります。これは、チーム間のコミュニケーションや共有の知識にギャップがあることを示唆しています。

> システムを設計する組織は、そのコミュニケーション構造をそっくりまねた構造の設計を生み出してしまう
> "Organizations which design systems are constrained to produce designs which are copies of the communication structures of these organizations."

Melvin E. Conway が提唱したこの法則は、組織の内部コミュニケーションの方法が、その組織が開発するプロダクトの構造に直接影響を与えるという考えを示しています。
組織内のコミュニケーションの質や方法が、プロダクトの品質や特性を形成する要因となるのです。

良好なドキュメンテーションは、組織内のメンバー全員が共有する情報の基準となります。明確でアクセシブルなドキュメンテーションは組織内のコミュニケーションの質や方法が確立され、スムーズになり、効率的な意思決定や問題解決しやすくなります。
