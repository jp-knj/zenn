...
プロダクトにコピーまたはコンテンツを追加する際、定義されたガイドラインは非常に役立ちます。明確なスタイルとトーンのガイドライン、そして一般的な仕組みに関する質問への回答は、一貫性のあるプロダクトを開発する上で不可欠です。しかし、ガイドラインの効果には限界があり、特にUI要素やパターン化されたコンポーネントの微細なスタイリングに関してです。
...
大文字と小文字について、見出し、ボタンのコピー、テーブルの見出し、テキスト入力フィールドなど、プロダクト内のさまざまな箇所でその選択は非常に目立ちます。しかし、一方を選びそれに固執するだけでよいわけではありません。どのスタイルをどこで使うかを適切に選択することで、UI要素を区別し、必要に応じてテキストに焦点を当てることができます。
見出しケースと文章ケースの違いは明確です。見出しケースでは、見出しの主要な単語の先頭を大文字にし、文章ケースでは文の先頭の文字だけを大文字にします。この区別は、主に一単語からなるデザイン要素、例えばボタンに関連しています。しかし、場合によっては2つの単語を使う必要が出てきます。その際、2つ目の単語の先頭を大文字にするかどうか、これを事前に考慮することが重要です。
...
ただし、注意が必要です。ガイドラインに見出しと文章ケースの概要を記載し、一般的な適用の指針を提供することも有用です。プロジェクト初期では、すべての状況においてどちらを選ぶべきかを完璧に定義することは困難かもしれません。そのため、一般的な指針を提供することで、適切な判断をサポートすることができます。
...
空の状態
空の状態はしばしば後回しにされがちですが、それは必要ではありません。それどころか、具体的な目標を達成するためのコンテンツやガイドラインとして理想的な場所です。空の状態はユーザーが未経験の機能を理解する助けになったり、使用できない製品の部分について説明する役割があります。空の状態のデザインにおいて、イラストが一つの焦点となることがありますが、それが最も重要な要素だとは限りません。何故なら、ユーザーにどのように問題を解決できるかを明確に伝えることが最も重要だからです。
...
マイクロコピー
簡潔で一貫した言語と視覚的表現は、コミュニケーションの鍵です。デザインシステムを利用すれば、常用される言語に対するガイドラインを提供し、不確かさを排除することができます。ツールチップやエラーメッセージは、ここでの重要なポイントです。これらのメッセージにおいて、製品のトーンやキャラクターをどれだけ反映させるかを決定する必要があります。
確認ダイアログでは、ボタンのラベルだけでなく、その背後にある意味やメッセージをユーザーに明確に伝えることが必要です。こうしたガイドラインを整理し、デザイナーが製品全体を一貫してデザインするためのサポートをすることが重要です。
ローカライゼーション
最後に、ローカライゼーションの重要性について触れます。国際化の過程で、日付や通貨、住所フォーマットなど、さまざまな要素を考慮する必要があります。また、文字列の長さや文化的な違いによるメタファーの解釈など、UI要素に直接影響を与える要素も多いです。
...
最終的に、製品のUIやコンポーネントに関するコンテンツの方向性を明確にすることで、より一貫性のあるユーザーエクスペリエンスを提供することができます。

ここでお話ししたような懸念事項に取り組んだとしても、それはまだ始まったばかりです。しかし、それは素晴らしいスタートです。コンテンツを標準化しなければならないような状況にはたくさん遭遇するでしょう。矛盾や混乱したシナリオをチームと話し合い、決定事項を文書化するのです。すぐに、製品のUI要素やパターン化されたコンポーネントのコンテンツに関する当て推量は必要なくなるでしょう。
