...
ユーザーの獲得ではなく、開発のコスト削減にもつながるという情報もあります。Forrester Research が Microsoft の依頼で行った経済影響調査によれば、アクセシビリティを既存の開発サイクルに組み込むことでコストの節約につながる可能性があると示唆しています[^10]。アクセシビリティを他のベストプラクティスとともに組み込むことは、保守やサービスのコスト削減を実証しています。
