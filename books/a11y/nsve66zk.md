---
title: "自動テストと手動テストをつなげる Accessibility Conformance Testing"
---

前回のセクションでは WCAG-EM について学びました。今回は、Web アクセシビリティテストの中での AST（Accessibility Conformance Testing）に焦点を当てます。AST は Web コンテンツの評価を基に、詳細な改善を支援する手法として役立ちます。この記事で、AST の活用方法と Web アクセシビリティの向上について詳しく解説します。
...
#### アクセシビリティ要件との一貫性
どの要素が要件の対象であり、どの要素が対象外であるかを正確に理解することが重要です。これにより、Web ページのアクセシビリティを正確に評価し、必要な修正できます。
