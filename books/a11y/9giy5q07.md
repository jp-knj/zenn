...
AAレベルを目標とし、AAAレベルについてはできる範囲で対応すると述べていますが、一部のコンテンツには適用しない場合もあることが示している組織は複数存在しています。
...
- 事例 3 : SmartHR では、.smarthr.jp で提供するすべてのサービスにおいて、JIS X 8341-3:2016のレベルAに準拠、WCAG 2.1のレベルAに準拠したアクセシビリティに対応していること [SmartHR Accessibility](https://accessibility.smarthr.co.jp/) にて表記しています。
