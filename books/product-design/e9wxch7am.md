...
| **意図**                  | **状況**                             | **次のステップ**                        | **反応の例**                                                                                          |
|-------------------------|------------------------------------|-----------------------------------|---------------------------------------------------------------------------------------------------|
| 解決すべき問題に同意しない           | この問題が解決すべきではないという証拠がある             | 証拠を持ってフィードバックを提供する                | 「データの報告によると、ユーザーはこのポイントを超えて画面をスクロールしているので、さらにスクロールを促すための追加の指示は不要ではないでしょうか                         |
| 問題を認識しない                | この新しい問題は今解決する価値があるのではないだろうか        | フィードバックを提供する                      | 「この色の組み合わせはコントラストが低く、アクセス可能ではありません。キャプションの読み取りが難しくなる可能性があり、懸念しています」                               |
