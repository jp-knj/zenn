...
ですが、Atomic Design という言葉によって"どうやるか"を考えすぎてしまったのではないのでしょうか

## 代替策は Scenario-Based Design
分類の観点だと、意図(特定の問題解決)によるグループ分けが良いと思われます。

もしも、具体的に挙げるなら
Atoms, Molecules, Organisms を Components をまとめてしまい、シナリオ(使用例)で分別された Components のまとまりを「Patterns」などでしょうか
